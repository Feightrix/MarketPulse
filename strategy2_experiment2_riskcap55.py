...
def main():
    ...
    with open("strategy2_experiment2_riskcap55_results.json", "w") as f:
    ...
    lines += ["", f"**Activation decision: {'PASS FOR FURTHER VALIDATION' if passed else 'REJECT 55% CANDIDATE'}**", ""]
    with open("strategy2_experiment2_riskcap55_summary.md", "w") as f:
        f.write("\n".join(lines))
    print("\n".join(lines))
